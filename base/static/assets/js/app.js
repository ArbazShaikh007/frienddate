!function () {
    var a, o, s, d, t, n, e, i, l, r, m, c, u = document.querySelector(".navbar-menu").innerHTML, g = 7, b = "en",
    ...
    function I(e) {
        if (e.target && e.target.matches("a.nav-link span")) if (0 == h(e.target.parentElement.nextElementSibling)) {
        ...
        if (e.target && e.target.matches("a.nav-link")) if (0 == h(e.target.nextElementSibling)) {
