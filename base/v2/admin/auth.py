import jwt, os, secrets, smtplib,boto3
...
admin_auth_v2 = Blueprint('admin_auth_v2', __name__)
...
def admin_register():
    if request.method == 'POST':
        ...
        if user:
            return redirect(url_for('admin_auth_v2.admin_login'))
...
@admin_auth_v2.route('/', methods=['POST', 'GET'])
def admin_login():
    if request.method == 'POST':
        ...
        if check_email and check_email.check_password(password):
            ...
            return redirect(url_for('admin_auth_v2.index'))
        else:
...
@admin_auth_v2.route('/index', methods=['POST', 'GET'])
@login_required
def index():
...
@admin_auth_v2.route('/admin/profile', methods=['POST', 'GET'])
@login_required
def admin_profile():
    return render_template('profile.html', data=current_user, common_path=COMMON_PATH)


@admin_auth_v2.route('/add_category', methods=['POST', 'GET'])
@login_required
def add_category():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_auth_v2.add_category'))
...
@admin_auth_v2.route('/admin/update', methods=['POST', 'GET'])
@login_required
def admin_update():
    if request.method == 'POST':
        ...
        # if user:
        #     # flash()
        #     return redirect(url_for('admin_auth_v2.admin_update'))
        #
        if not admin_image:
...
@admin_auth_v2.route('/admin/change_pwd', methods=['POST'])
@login_required
def change_password():
...
# @admin_auth_v2.route('/admin/edit', methods=['GET'])
# @login_required
# def edit_category():
...
@admin_auth_v2.route('/category/update', methods=['POST', 'GET'])
@login_required
def update_category():
...
@admin_auth_v2.route('/delete_category/<int:id>', methods=['POST'])
@login_required
...
@admin_auth_v2.route('/add/news', methods=['GET', 'POST'])
@login_required
def add_news():
    x = terms_condition(3)
...
@admin_auth_v2.route('/view/privacy', methods=['GET', 'POST'])
@login_required
def view_privacy():
    x = terms_condition(2)
...
@admin_auth_v2.route('/view/terms', methods=['GET', 'POST'])
@login_required
def view_terms():
    x = terms_condition(1)
...
@admin_auth_v2.route('/view/how_to_use', methods=['GET', 'POST'])
@login_required
def view_how_to_use():
    x = terms_condition(4)
...
@admin_auth_v2.route('/view/information', methods=['GET', 'POST'])
@login_required
...
@admin_auth_v2.route('/view/store', methods=['GET', 'POST'])
@login_required
def view_store():
    x = terms_condition(6)
...
@admin_auth_v2.route('/view/brand_deals', methods=['GET', 'POST'])
@login_required
...
def send_mail(user):
    ...
    {url_for('admin_auth_v2.reset_token', token=token, _external = True)}
...
@admin_auth_v2.route('/admin/reset_request', methods=['GET', 'POST'])
def reset_request():
    if request.method == 'POST':
        ...
        if not user:
            ...
            return redirect(url_for('admin_auth_v2.reset_request'))
        if user:
...
@admin_auth_v2.route('/admin/reset_password/<token>', methods=['GET', 'POST'])
def reset_token(token):
    ...
    if request.method == 'POST':
        ...
        if admin_password == admin_confirm_password:
            ...
            return redirect(url_for('admin_auth_v2.reset_token', token=token))
    return render_template('resetPassword.html', common_path=COMMON_PATH)


@admin_auth_v2.route('/logout')
def logout():
    logout_user()
...
@admin_auth_v2.route('/blocked_words', methods=['POST', 'GET'])
@login_required
def blocked_words():
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_auth_v2.blocked_words'))
...
@admin_auth_v2.route('/delete_blocked_word/<int:id>', methods=['POST'])
@login_required
...
@admin_auth_v2.route('/blocked_word/update', methods=['POST', 'GET'])
@login_required
...
@admin_auth_v2.route('/add_badges', methods=['POST', 'GET'])
@login_required
def add_badges():
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_auth_v2.add_badges'))
...
@admin_auth_v2.route('/delete_badge/<int:id>', methods=['POST'])
@login_required
def delete_badge(id):
...
@admin_auth_v2.route('/badge/update', methods=['POST', 'GET'])
@login_required
def update_badge():
    id = request.form.get('updateId')
    badge_name = request.form.get('badge_name')
...
@admin_auth_v2.route('/add_buddys', methods=['POST', 'GET'])
@login_required
def add_buddys():
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_auth_v2.add_buddys'))
...
@admin_auth_v2.route('/delete_buddy/<int:id>', methods=['POST'])
@login_required
def delete_buddy(id):
...
@admin_auth_v2.route('/buddy/update', methods=['POST', 'GET'])
@login_required
def update_buddy():
    id = request.form.get('updateId')
    type = request.form.get('type')
