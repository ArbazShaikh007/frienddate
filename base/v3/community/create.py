...
community_create_v3 = Blueprint('community_create_v3', __name__)

@community_create_v3.route('/add_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v3.route('/save_community', methods=['POST'])
@token_required
def save_community(active_user):
    ...
    if created_community:
        ...
        if validate:
            ...
            communit = SavedCommunity(city = created_community.city,state = created_community.state,created_id=created_community.id, community_name=created_community.community_name,
...
@community_create_v3.route('/join_community', methods=['POST'])
@token_required
...
@community_create_v3.route('/my_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v3.route('/community_library', methods=['POST'])
@token_required
...
@community_create_v3.route('/community_list', methods=['POST'])
@token_required
...
@community_create_v3.route('/community_post', methods=['GET', 'POST'])
@token_required
...
@community_create_v3.route('/like_post', methods=['POST'])
@token_required
...
@community_create_v3.route('/thumsup_post', methods=['POST'])
@token_required
...
@community_create_v3.route('/thumsdown_post', methods=['POST'])
@token_required
...
@community_create_v3.route('/post_comment', methods=['GET', 'POST'])
@token_required
...
@community_create_v3.route('/view/post_comment', methods=['POST'])
@token_required
...
@community_create_v3.route('/post_list', methods=['POST'])
@token_required
...
@community_create_v3.route('/delete_post', methods=['POST'])
@token_required
