...
user_auth_v3 = Blueprint('user_auth_v3', __name__)


@user_auth_v3.route('/replace_s3', methods=['GET'])
def replace_s3():
...
@user_auth_v3.route('/register', methods=['POST'])
def register():
...
@user_auth_v3.route('/login', methods=['POST'])
def user_login():
    if request.method == 'POST':
...
@user_auth_v3.route("/token_verification")
@token_required
...
@user_auth_v3.route('/change_pwd', methods=['POST'])
@token_required
...
@user_auth_v3.route('/user_update', methods=['POST', 'GET'])
@token_required
...
@user_auth_v3.route('/double_verification', methods=['POST'])
@token_required
...
@user_auth_v3.route("/user_to_user/block", methods=['POST'])
@token_required
...
@user_auth_v3.route("/block_list", methods=['GET'])
@token_required
...
@user_auth_v3.route("/user/report", methods=['POST'])
@token_required
...
@user_auth_v3.route("/user/forget_password", methods=['POST'])
...
@user_auth_v3.route("/user/new_password", methods=['POST'])
@token_required
...
@user_auth_v3.route("/subscription", methods=['POST'])
@token_required
...
@user_auth_v3.route('/add_image_s', methods=['GET', 'POST'])
def add_image_s():
