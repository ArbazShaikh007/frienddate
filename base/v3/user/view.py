...
user_view_v3 = Blueprint('user_view_v3', __name__)


# hi

@user_view_v3.route('/homepage_verify_token', methods=['POST'])
@token_required
...
@user_view_v3.route('/homepage', methods=['POST'])
@token_required
...
@user_view_v3.route('/homepage_filter', methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/category_list', methods=['GET', 'POST'])
@token_required
def category_list(active_user):
    ...
    categories_with_count = db.session.query(
        Category,
        func.count(CreatedCommunity.id)
    ).join(CreatedCommunity).group_by(Category).all()

    list = [category.as_dict(count) for category, count in categories_with_count]
    ...
    if filter_text == 1:
        ...
        reverse = False
    if len(list) > 0:
        return jsonify({'status': 1, 'category_list': sorted(list, key=sort_key, reverse=reverse)})
    else:
        return jsonify(
            {'status': 1, 'category_list': [], 'messege': 'Dont have any category yet'})


@user_view_v3.route('/users_list', methods=['GET'])
@token_required
...
@user_view_v3.route('/send_friend_req', methods=['POST'])
@token_required
...
@user_view_v3.route('/req_list', methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/req_action', methods=['POST'])
@token_required
...
@user_view_v3.route('/friends_list', methods=['POST'])
@token_required
...
@user_view_v3.route('/friends_list_id', methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/get_category', methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/view_profile', methods=['POST'])
@token_required
...
@user_view_v3.route("/user/delete", methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route("/matches/category_vise", methods=['POST'])
@token_required
...
@user_view_v3.route("/get/terms_conditions", methods=['GET'])
def get_terms_conditions():
    x = terms_condition(1)
    return jsonify({'status': 1, 'content': x.as_dict()})


@user_view_v3.route("/get/privacy_policy", methods=['GET'])
def get_privacy_policy():
    x = terms_condition(2)
    return jsonify({'status': 1, 'content': x.as_dict()})


@user_view_v3.route("/get/news", methods=['GET'])
@token_required
...
@user_view_v3.route("/get/how_to_use", methods=['GET'])
@token_required
...
@user_view_v3.route("/get/information", methods=['GET'])
@token_required
...
@user_view_v3.route("/get/stores", methods=['GET'])
@token_required
...
@user_view_v3.route("/get/brands_deals", methods=['GET'])
@token_required
...
@user_view_v3.route("/get/faq", methods=['GET'])
@token_required
...
@user_view_v3.route("/search/user", methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/get/tag_friends', methods=['POST'])
@token_required
...
@user_view_v3.route('/tag_friends', methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/post/mute_unmute', methods=['GET', 'POST'])
@token_required
...
@user_view_v3.route('/community/unsave', methods=['POST'])
@token_required
...
@user_view_v3.route('/featured_page', methods=['POST'])
@token_required
...
@user_view_v3.route('/matches/filter_community_vice', methods=['POST'])
@token_required
...
@user_view_v3.route('/matches/community_vice', methods=['POST'])
@token_required
...
@user_view_v3.route('/notification_list', methods=['POST'])
@token_required
...
@user_view_v3.route('/notification_button', methods=['POST'])
@token_required
...
@user_view_v3.route('/get_notification_button', methods=['GET'])
@token_required
...
@user_view_v3.route('/ranking_page', methods=['POST'])
@token_required
...
@user_view_v3.route('/verify-receipt', methods=['POST'])
@token_required
...
@user_view_v3.route('/get/countries', methods=['GET'])
def get_countries():
...
@user_view_v3.route('/get/states', methods=['POST'])
def get_states():
