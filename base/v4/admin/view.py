...
from base.user.models import User, Report,SelectedCategory
...
admin_views_v4 = Blueprint('admin_views_v4', __name__)
...
@admin_views_v4.route('/view/users', methods=['POST', 'GET'])
@login_required
def view_users():
...
@admin_views_v4.route('/view/featured_list', methods=['POST', 'GET'])
@login_required
...
@admin_views_v4.route('/add_users_featured_page', methods=['GET'])
@login_required
def add_users_featured_page():
    ...
    if user_data:
        if user_data.is_featured == False:
            ...
            db.session.commit()
            if page == 'user_list':
                return redirect(url_for('admin_views_v4.view_users'))
            if page == 'feartured':
                return redirect(url_for('admin_views_v4.view_featured_list'))
...
@admin_views_v4.route('/user/reports', methods=['POST', 'GET'])
@login_required
def user_reports():
    # get_page = request.args.get('page', 1, type=int)
...
@admin_views_v4.route("/user/block/<int:id>", methods=['POST'])
@login_required
def block_user(id):
...
@admin_views_v4.route('/view/terms_conditions', methods=['POST', 'GET'])
@login_required
def terms_conditions():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.terms_conditions'))

    return render_template('termsConditions.html', data=current_user, content=x, page='terms', common_path=COMMON_PATH)


@admin_views_v4.route('/view/privacy_policies', methods=['POST', 'GET'])
@login_required
def privacy_policies():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.privacy_policies'))

    return render_template('privacyPolicies.html', data=current_user, content=x, page='privacy',
                           common_path=COMMON_PATH)


@admin_views_v4.route('/add/faq', methods=['POST', 'GET'])
@login_required
def add_faq():
    get_page = request.args.get('page', 1, type=int)
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.add_faq'))
...
@admin_views_v4.route('/delete_faq/<int:id>', methods=['POST'])
@login_required
def delete_faq(id):
...
@admin_views_v4.route('/faq/update', methods=['POST', 'GET'])
@login_required
def update_faq():
...
@admin_views_v4.route('/how_to_use_friend_date', methods=['POST', 'GET'])
@login_required
def how_to_use_app():
    x = terms_condition(4)
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.how_to_use_app'))

    return render_template('howtouseFrienddate.html', data=current_user, content=x, page='app_use',
                           common_path=COMMON_PATH)


@admin_views_v4.route('/information', methods=['POST', 'GET'])
@login_required
def information():
    x = terms_condition(5)
...
@admin_views_v4.route("/user/reports", methods=['GET', 'POST'])
@login_required
def view_reports():
    return render_template('reports.html', data=current_user, common_path=COMMON_PATH)


@admin_views_v4.route('/places_community_list', methods=['POST', 'GET'])
@login_required
def places_community_list():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.places_community_list',category_id = category_id))
...
@admin_views_v4.route('/delete_places_community_link/<int:id>', methods=['POST'])
@login_required
def delete_places_community_link(id):
    ...
    return redirect(url_for('admin_views_v4.places_community_list',category_id = community_data.category_id))

@admin_views_v4.route('/admin_things_community_list', methods=['POST', 'GET'])
@login_required
def admin_things_community_list():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.admin_things_community_list',category_id = category_id))
...
@admin_views_v4.route('/delete_things_community_link/<int:id>', methods=['POST'])
@login_required
def delete_things_community_link(id):
    ...
    return redirect(url_for('admin_views_v4.admin_things_community_list',category_id = community_data.category_id))

@admin_views_v4.route('/add_things_category', methods=['POST', 'GET'])
@login_required
def add_things_category():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.add_things_category'))
...
@admin_views_v4.route('/delete_things_category/<int:id>', methods=['POST'])
@login_required
...
@admin_views_v4.route('/things_category/update', methods=['POST', 'GET'])
@login_required
...
@admin_views_v4.route('/add_buttons', methods=['POST', 'GET'])
@login_required
def add_buttons():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.add_buttons'))
...
@admin_views_v4.route('/delete_buttons/<int:id>', methods=['POST'])
@login_required
...
@admin_views_v4.route('/button_data/update', methods=['POST', 'GET'])
@login_required
...
@admin_views_v4.route('/add_questions_category', methods=['POST', 'GET'])
@login_required
def add_questions_category():
    ...
    if request.method == 'POST':
        ...
        insert_data(category_data)
        return redirect(url_for('admin_views_v4.add_questions_category'))
...
@admin_views_v4.route('/delete_questions_category/<int:id>', methods=['POST'])
@login_required
...
@admin_views_v4.route('/questions_category/update', methods=['POST', 'GET'])
@login_required
...
@admin_views_v4.route('/add/questions', methods=['POST', 'GET'])
@login_required
def add_questions():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('admin_views_v4.add_questions',id = questions_category_id))
...
@admin_views_v4.route('/edit/questions', methods=['POST', 'GET'])
@login_required
def edit_questions():
    id = request.form.get('updateId')
    ...
    return redirect(url_for('admin_views_v4.add_questions',id = get_question_data.questions_category_id))

@admin_views_v4.route('/delete_question/<int:id>/<int:category_id>', methods=['POST'])
@login_required
def delete_question(id,category_id):
    ...
    return redirect(url_for('admin_views_v4.add_questions', id = category_id))