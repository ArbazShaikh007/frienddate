...
from base.user.models import token_required, TagFriends, User, ChatMute, Notification, Block,Feed,Follow,LikeRecommendation
...
community_create_v4 = Blueprint('community_create_v4', __name__)
...
@community_create_v4.route('/recommendation_community_list', methods=['POST'])
@token_required
...
@community_create_v4.route('/recommendation_things_community_list', methods=['POST'])
@token_required
...
@community_create_v4.route('/add_places_recommendation', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/add_things_recommendation', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/delete_places_community_review', methods=['POST'])
@token_required
...
@community_create_v4.route('/get_places_community_review', methods=['POST'])
@token_required
...
@community_create_v4.route('/add_places_community_review', methods=['GET', 'POST'])
@token_required
def add_places_community_review(active_user):
    ...
    add_places_review = PlacesReview(rate=rate,text = text,image_name = image_name,image_path = image_url,created_time = datetime.utcnow(),community_id = community_id,user_id = active_user.id)
...
@community_create_v4.route('/delete_things_community_review', methods=['POST'])
@token_required
...
@community_create_v4.route('/get_things_community_review', methods=['POST'])
@token_required
...
@community_create_v4.route('/add_things_community_review', methods=['GET', 'POST'])
@token_required
def add_things_community_review(active_user):
    ...
    add_things_review = ThingsReview(text = text,image_name = image_name,image_path = image_url,created_time = datetime.utcnow(),community_id = community_id,user_id = active_user.id)
...
@community_create_v4.route('/add_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/add_things_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/save_community', methods=['POST'])
@token_required
...
@community_create_v4.route('/save_things_community', methods=['POST'])
@token_required
...
@community_create_v4.route('/join_community', methods=['POST'])
@token_required
...
@community_create_v4.route('/my_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/my_things_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/community_library', methods=['POST'])
@token_required
...
@community_create_v4.route('/search_in_community_list', methods=['POST'])
@token_required
...
@community_create_v4.route('/community_list', methods=['POST'])
@token_required
...
@community_create_v4.route('/search_in_things_community_list', methods=['POST'])
@token_required
        ...
        for id, city, state, community_name, count in created_data.items:
            ...
            same_community_members_data = (db.session.query(SavedThingsCommunity, User)
                                           ...
                                           .filter(User.is_block == False, User.deleted == False,
                                                   ...
                                                   ~SavedThingsCommunity.user_id.in_(blocked_by_user_ids)).limit(
                1).all())
            print('same_community_members_data', same_community_members_data)
...
@community_create_v4.route('/things_community_list', methods=['POST'])
@token_required
...
@community_create_v4.route('/community_post', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/like_post', methods=['POST'])
@token_required
...
@community_create_v4.route('/thumsup_post', methods=['POST'])
@token_required
...
@community_create_v4.route('/thumsdown_post', methods=['POST'])
@token_required
...
@community_create_v4.route('/post_comment', methods=['GET', 'POST'])
@token_required
...
@community_create_v4.route('/view/post_comment', methods=['POST'])
@token_required
...
@community_create_v4.route('/post_list', methods=['POST'])
@token_required
...
@community_create_v4.route('/delete_post', methods=['POST'])
@token_required
