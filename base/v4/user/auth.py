...
user_auth_v4 = Blueprint('user_auth_v4', __name__)


@user_auth_v4.route('/replace_s3', methods=['GET'])
def replace_s3():
...
@user_auth_v4.route('/register', methods=['POST'])
def register():
...
@user_auth_v4.route('/login', methods=['POST'])
def user_login():
    if request.method == 'POST':
...
@user_auth_v4.route('/social_register', methods=['POST'])
def social_register():
    if request.method == 'POST':
...
@user_auth_v4.route("/token_verification")
@token_required
...
@user_auth_v4.route('/change_pwd', methods=['POST'])
@token_required
...
@user_auth_v4.route('/user_update', methods=['POST', 'GET'])
@token_required
def user_update(active_user):
    ...
    if request.method == 'POST':
        ...
        if user_image:
            ...
            user_data = User(new_bio = new_bio,college=college, about_me=about_me, description_box=description_box, id=active_user.id,
...
@user_auth_v4.route('/double_verification', methods=['POST'])
@token_required
...
@user_auth_v4.route("/user_to_user/block", methods=['POST'])
@token_required
...
@user_auth_v4.route("/block_list", methods=['GET'])
@token_required
...
@user_auth_v4.route("/user/report", methods=['POST'])
@token_required
...
@user_auth_v4.route("/user/forget_password", methods=['POST'])
...
@user_auth_v4.route("/user/new_password", methods=['POST'])
@token_required
...
@user_auth_v4.route("/subscription", methods=['POST'])
@token_required
...
@user_auth_v4.route('/add_image_s', methods=['GET', 'POST'])
def add_image_s():
