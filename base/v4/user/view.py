...
from base.user.models import token_required, FriendRequest, User, DateRequest, TagFriends, \
...
from base.admin.models import LikeUserAnswer, Category, Faqs,ThingsCategory,CategoryQue,CategoryAns,QuestionsCategory,Buttons
from base import db
from base.community.models import SavedCommunity,CreatedThingsCommunity, CreatedCommunity, CommunityPost,ThingsRecommendation,PlacesRecommendation,PlacesReview,ThingsReview
...
user_view_v4 = Blueprint('user_view_v4', __name__)
...
@user_view_v4.route('/top_followed_users', methods=['GET'])
@token_required
...
@user_view_v4.route('/like_recommendation', methods=['POST'])
@token_required
...
@user_view_v4.route('/new_notification_list', methods=['POST'])
@token_required
...
@user_view_v4.route('/like_things_review_comment', methods=['POST'])
@token_required
...
@user_view_v4.route('/delete_things_review_comment', methods=['POST'])
@token_required
...
@user_view_v4.route('/add_comment_things_review', methods=['POST'])
@token_required
...
@user_view_v4.route('/like_things_review', methods=['POST'])
@token_required
...
@user_view_v4.route('/like_places_review_comment', methods=['POST'])
@token_required
...
@user_view_v4.route('/delete_places_review_comment', methods=['POST'])
@token_required
...
@user_view_v4.route('/add_comment_places_review', methods=['POST'])
@token_required
...
@user_view_v4.route('/like_places_review', methods=['POST'])
@token_required
...
@user_view_v4.route('/like_feed_comment', methods=['POST'])
@token_required
...
@user_view_v4.route('/delete_feed_comment', methods=['POST'])
@token_required
...
@user_view_v4.route('/feed_comment_list', methods=['POST'])
@token_required
...
@user_view_v4.route('/add_comment_feed', methods=['POST'])
@token_required
...
@user_view_v4.route('/like_feed', methods=['POST'])
@token_required
...
@user_view_v4.route('/delete_feed', methods=['POST'])
@token_required
...
@user_view_v4.route('/users_review_list', methods=['POST'])
@token_required
...
@user_view_v4.route('/feed_page', methods=['POST'])
@token_required
def feed_page(active_user):
    ...
    feed_data = Feed.query.filter(Feed.user_id != active_user.id, Feed.user_id.in_(followed_list)).order_by(Feed.id.desc()).paginate(page=page, per_page=per_page, error_out=False)
...
@user_view_v4.route('/user_feed_page', methods=['POST'])
@token_required
...
@user_view_v4.route('/add_activity_post', methods=['POST'])
@token_required
def add_activity_post(active_user):
    ...
    if not text and not content.filename:
    ...
    add_feed_data = Feed(type = type,text=text,thumbnail_path= thumbnail_path,video_path = video_url, image_name=image_name, image_path=image_url,
...
@user_view_v4.route('/follow_user', methods=['POST'])
@token_required
...
@user_view_v4.route('/followers_list', methods=['POST'])
@token_required
...
@user_view_v4.route('/user_recommendation_category', methods=['POST'])
@token_required
def user_recommendation_category(active_user):
    ...
    if tab == 1:
        ...
        if not len(get_places_recommendation_data)>0:
            return jsonify({'status': 1,'messege': 'Dont have any recommendation yet'})
...
@user_view_v4.route('/homepage_verify_token', methods=['POST'])
@token_required
...
@user_view_v4.route('/homepage', methods=['POST'])
@token_required
...
@user_view_v4.route('/homepage_filter', methods=['GET', 'POST'])
@token_required
def homepage_filter(active_user):
    if request.method == 'POST':
        ...
        query = (db.session.query(User, matches_subq.c.matches).outerjoin(matches_subq,
            ...
            User.id.not_in(blocked_by_user_ids)).filter(matches_subq.c.matches != None).order_by(matches_subq.c.matches.desc()))
        if country:
...
@user_view_v4.route('/category_list', methods=['GET', 'POST'])
@token_required
def category_list(active_user):
    ...
    if tab == 0:
        ...
        print('countsssssssssssssssssssssssssssssssssssssssssssssssss', len(categories_with_count))
        ...
        if filter_text == 1:
            ...
            print('category_listtttttttttttttttttttttt', category_list)
        ...
        if len(category_list) > 0:
            return jsonify({'status': 1, 'messege': 'Success',
                            'category_list': sorted(category_list, key=sort_key, reverse=reverse)})
        else:
            return jsonify(
                {'status': 1, 'category_list': [], 'messege': 'Dont have any category yet'})
    ...
    if tab == 1:
        ...
        category_list = [i.as_dict() for i in things_category]
...
@user_view_v4.route('/answered_things_category_list', methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/users_list', methods=['GET'])
@token_required
...
@user_view_v4.route('/send_friend_req', methods=['POST'])
@token_required
...
@user_view_v4.route('/req_list', methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/req_action', methods=['POST'])
@token_required
...
@user_view_v4.route('/friends_list', methods=['POST'])
@token_required
...
@user_view_v4.route('/friends_list_id', methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/get_category', methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/view_profile', methods=['POST'])
@token_required
...
@user_view_v4.route("/user/delete", methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route("/get_buttons_data", methods=['POST'])
@token_required
def get_buttons_data(active_user):
    ...
    total_liked_Recommendation = LikeRecommendation.query.filter_by(user_id=user_id).count()

    return jsonify({'status': 1, 'messege': 'Success', 'button_list': button_data, 'is_follow': is_follow,
                    'following_count': str(following_count),'total_liked_Recommendation': str(total_liked_Recommendation)})

@user_view_v4.route("/matches/category_vise", methods=['POST'])
@token_required
...
@user_view_v4.route("/get/terms_conditions", methods=['GET'])
def get_terms_conditions():
    x = terms_condition(1)
    return jsonify({'status': 1, 'content': x.as_dict()})


@user_view_v4.route("/get/privacy_policy", methods=['GET'])
def get_privacy_policy():
    x = terms_condition(2)
    return jsonify({'status': 1, 'content': x.as_dict()})


@user_view_v4.route("/get/news", methods=['GET'])
@token_required
...
@user_view_v4.route("/get/how_to_use", methods=['GET'])
@token_required
...
@user_view_v4.route("/get/information", methods=['GET'])
@token_required
...
@user_view_v4.route("/get/stores", methods=['GET'])
@token_required
...
@user_view_v4.route("/get/brands_deals", methods=['GET'])
@token_required
...
@user_view_v4.route("/get/faq", methods=['GET'])
@token_required
...
@user_view_v4.route("/search/user", methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/get/tag_friends', methods=['POST'])
@token_required
...
@user_view_v4.route('/tag_friends', methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/post/mute_unmute', methods=['GET', 'POST'])
@token_required
...
@user_view_v4.route('/community/unsave', methods=['POST'])
@token_required
...
@user_view_v4.route('/delete_things_community', methods=['POST'])
@token_required
...
@user_view_v4.route('/featured_page', methods=['POST'])
@token_required
...
@user_view_v4.route('/matches/filter_community_vice', methods=['POST'])
@token_required
...
@user_view_v4.route('/matches/community_vice', methods=['POST'])
@token_required
...
@user_view_v4.route('/notification_list', methods=['POST'])
@token_required
...
@user_view_v4.route('/notification_button', methods=['POST'])
@token_required
...
@user_view_v4.route('/get_notification_button', methods=['GET'])
@token_required
...
@user_view_v4.route('/ranking_page', methods=['POST'])
@token_required
...
@user_view_v4.route('/verify-receipt', methods=['POST'])
@token_required
...
@user_view_v4.route('/get/countries', methods=['GET'])
def get_countries():
...
@user_view_v4.route('/get/states', methods=['POST'])
def get_states():
...
@user_view_v4.route('/get_quetions', methods=['POST'])
@token_required
...
@user_view_v4.route('/get_users_quetions_answers', methods=['POST'])
@token_required
...
@user_view_v4.route('/give_answer', methods=['POST'])
@token_required
