...
from base.user.models import RecommendationComments,NewNotification,token_required, TagFriends, User, ChatMute, Notification, Block,Feed,Follow,LikeRecommendation
from base.community.models import ThingsRecommendation,PlacesRecommendation,ThingsReview,PlacesReview, SavedThingsCommunity,CreatedThingsCommunity, SavedCommunity, CommunityPost, PostLike, PostThumsup, PostComment, PostThumpdown, \
    CreatedCommunity
...
community_create_v6 = Blueprint('community_create_v6', __name__)
...
@community_create_v6.route('/recommendation_comments_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/recommendation_my_community_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/recommendation_community_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/recommendation_my_things_community_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/recommendation_things_community_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/add_recommendation_content', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/add_places_recommendation', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/add_things_recommendation', methods=['GET', 'POST'])
@token_required
def add_things_recommendation(active_user):
    ...
    if check_recommendation:
        ...
        add_notification_data = NewNotification(title=title, message=text, page='things recommendation', is_read=False,
                                                created_time=datetime.utcnow(), by_id=active_user.id,
                                                to_id=get_community_data.user_id)
        db.session.add(add_notification_data)
        db.session.commit()
...
@community_create_v6.route('/delete_places_community_review', methods=['POST'])
@token_required
...
@community_create_v6.route('/get_places_community_review', methods=['POST'])
@token_required
...
@community_create_v6.route('/add_places_community_review', methods=['GET', 'POST'])
@token_required
def add_places_community_review(active_user):
    ...
    if not text and not image.filename and not title:
...
@community_create_v6.route('/delete_things_community_review', methods=['POST'])
@token_required
...
@community_create_v6.route('/get_things_community_review', methods=['POST'])
@token_required
...
@community_create_v6.route('/add_things_community_review', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/add_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/add_things_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/save_community', methods=['POST'])
@token_required
...
@community_create_v6.route('/save_things_community', methods=['POST'])
@token_required
...
@community_create_v6.route('/join_community', methods=['POST'])
@token_required
...
@community_create_v6.route('/my_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/my_things_community', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/community_library', methods=['POST'])
@token_required
...
# @community_create_v6.route('/search_in_community_list', methods=['POST'])
# @token_required
...
#
#     if city:
#         query = query.filter(CreatedCommunity.city.like('%' + city + '%'))
#     if state:
#         query = query.filter(CreatedCommunity.state.like('%' + state + '%'))
#     if community_name:
#         query = query.filter(CreatedCommunity.community_name.like('%' + community_name + '%'))
#
#     created_data = query.paginate(page=page, per_page=per_page, error_out=False)
#
#     community_data = []
...
#                                                    ~SavedCommunity.user_id.in_(blocked_by_user_ids)).limit(5).all())
...
@community_create_v6.route('/community_homepage', methods=['POST'])
@token_required
...
# @community_create_v6.route('/community_list', methods=['POST'])
# @token_required
...
@community_create_v6.route('/liked_places_community_list', methods=['POST'])
@token_required
def liked_community_list(active_user):
    ...
    query = db.session.query(
        ...
        SavedCommunity.created_id.in_(included_created_ids)  # Exclude the IDs from the subquery
    ). \
        group_by(CreatedCommunity.id)
...
@community_create_v6.route('/search_in_things_community_list', methods=['POST'])
@token_required
def search_in_things_community_list(active_user):
    ...
    if city:
        query = query.filter(CreatedThingsCommunity.city.like('%' + city + '%'))
    if state:
        query = query.filter(CreatedThingsCommunity.state.like('%' + state + '%'))
    if community_name:
        query = query.filter(CreatedThingsCommunity.community_name.like('%' + community_name + '%'))
    ...
    if created_data.items:
        ...
        return jsonify({'status': 1,'counts': str(total_community_count), 'data': [], 'messege': 'You Not Save Any Words Yet', "category_id": category_id,'pagination_info':pagination_info})


@community_create_v6.route('/things_community_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/community_post', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/like_post', methods=['POST'])
@token_required
...
@community_create_v6.route('/thumsup_post', methods=['POST'])
@token_required
...
@community_create_v6.route('/thumsdown_post', methods=['POST'])
@token_required
...
@community_create_v6.route('/post_comment', methods=['GET', 'POST'])
@token_required
...
@community_create_v6.route('/view/post_comment', methods=['POST'])
@token_required
...
@community_create_v6.route('/post_list', methods=['POST'])
@token_required
...
@community_create_v6.route('/delete_post', methods=['POST'])
@token_required
